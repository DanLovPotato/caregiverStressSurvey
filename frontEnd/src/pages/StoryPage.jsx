...
function StoryPage() {
  ...
  return (
    <div className="container" style={{ backgroundColor: '#ECF6FF',  paddingLeft: '0', paddingTop: '0', overflowY: 'scroll'}}>
      ...
      <div className="story-content" style={{ display: 'flex', flexDirection: 'column', padding: '20px', marginTop: '20px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          ...
          <p style={{ flex: '1', textAlign: 'right', fontSize:'32px', textAlign:'left', marginTop:'0' }}>
      ...
      <div className="story-content" style={{ display: 'flex', flexDirection: 'column', padding: '20px', marginTop: '20px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <p style={{ flex: '1', textAlign: 'left', fontSize:'32px', textAlign:'left', marginTop:'0', marginLeft:'91px' }}>
          ...
          <h3 style={{ fontSize:'48px', textAlign:'left', paddingLeft:'71px', marginTop:'0', marginRight:'201px' }}>
          Caregiver Burnout
          </h3>
        </div>
      </div>
      <div className="story-content" style={{paddingTop: '64px', paddingBottom: '342px'}}>
    ...
    <div className="story-content" style={{ backgroundColor:'#6AADEB', height:'528px'}}>
      <h3 style={{ fontSize: '64px', paddingTop: '120px', textAlign: 'left', marginLeft: '99px'}}>
    ...
    <div className="story-content" style={{ backgroundColor:'#6AADEB', height:'624px'}}>
      <h3 style={{ fontSize: '64px', paddingTop: '120px', textAlign: 'left', marginLeft: '99px'}}>
    ...
    <div className="story-content" style={{ marginTop: '85px', marginLeft: '73px', marginRight: '73px', marginBottom: '42px',display: 'flex', flexDirection: 'row'}}>
      ...
      <div className="column" style={{ display: 'flex', flexDirection: 'column', textAlign: 'left', width: '820px'}}>
        ...
        <p style={{ fontSize: '32px'}}>If our story has resonated with you<br/> and you believe in the value this test can bring, we warmly invite you to share it with your circle. Your support in sharing our message helps us reach more people who can benefit from our work.</p>
        <div className="buttons" style={{ display: 'flex', flexDirection: 'row', width: '604px', height: '71px', margin: '0', backgroundColor: '#C4E1F2', borderRadius: '8px'}}>
          <p style={{ width: '285px', display: 'flex', flexDirection: 'column', color: '#4B4B4B', fontWeight: 'bold', paddingLeft: '26px', paddingRight: '66px', fontSize: '20px'}}>https://www.careyaya.org/</p>
